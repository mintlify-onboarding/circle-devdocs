...
permalink: "w3s-2025"
'og:title': "Release Notes - Developer Services - 2025"
'og:description': "2025 release notes for Circle's Developer Services platform."
'twitter:title': "Release Notes - Developer Services - 2025"
'twitter:description': "2025 release notes for Circle's Developer Services platform."
---
...
* [Receive an Inbound Transfer](/wallets/dev-controlled/receive-an-inbound-transfer)
* [Receive an Inbound Transfer](/wallets/user-controlled/receive-inbound-transfer)
...
* [Configure Transfer Speed and Maximum Cost](/bridge-kit/tutorials/configure-transfer-speed)
...
* [Getting Started with Developer-Controlled Wallets - Node.js](/sdk-explorer/developer-controlled-wallets/de.js/getting-started)
...
* [Getting Started with User-Controlled Wallets - Node.js](/sdk-explorer/user-controlled-wallets/de.js/getting-started)
* [Getting Started with User-Controlled Wallets - Python](/sdk-explorer/user-controlled-wallets/Python/getting-started)
* [Getting Started with Contracts - Node.js](/sdk-explorer/smart-contract-platform/de.js/getting-started)
