...
<Glossary term="Entity Secret" />. You can use standard libraries for generating
and encrypting the Entity Secret, or SDK methods to simplify your development
journey. Likewise, for registering an
<Glossary term="Entity Secret Ciphertext" />, you can use an SDK method or the
Circle Console.
...
request to the
[Get public key for entity](/api-reference/w3s/programmable-wallets/get-public-key)
...
1. [Create your first developer-controlled wallet](/w3s/docs/developer-controlled-create-your-first-wallet)
2. [Rotate and Reset Entity Secret](/w3s/docs/developer-controlled-transfer-tokens-across-wallets):
   Check out how you can
   [rotate and reset](/w3s/docs/entity-secret-management#how-to-rotate-the-entity-secret)
   your Entity Secret.
