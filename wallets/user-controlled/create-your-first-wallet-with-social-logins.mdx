---
title: Create Your First Wallet with Social Logins
description:
...
<Frame>
  <img src="/w3s/images/ucw-cyfwwsl-sampleapp01.png" />
</Frame>
...
<Frame>
  <img src="/w3s/images/ucw-cyfwwsl-socialgoogle01.png" />
</Frame>

<Frame>
  <img src="/w3s/images/ucw-cyfwwsl-socialfb01.png" />
</Frame>
...
2. Copy `deviceToken` and `deviceEncryptionKey` from the response and enter them
   ...
   ```
    ...
    <Frame>
    <img src="/w3s/images/ucw-cyfwwsl-sampleapp02.png" />
    </Frame>
...
3. On the sample app, select **Login with Google** or **Login with Facebook**.
   ...
   method `performLogin`.
    ...
    <Frame>
    <img src="/w3s/images/ucw-cyfwwsl-socialgoogle02.png" />
    </Frame>
...
```typescript import { createContext, ReactNode, useCallback, useContext, useEffect, useMemo, useState } from 'react'
...
4. After a successful login, you are redirected back to the main page of this
   sample app. The "Execute Challenge" section is now visible.
    ...
    <Frame>
      <img src="/w3s/images/ucw-cyfwwsl-sampleapp03_copy_1.png" />
    </Frame>
...
5. Select **Execute Challenge**.
   ...
   are required for the next step, which is to initialize the user.
    ...
    <Frame>
    <img src="/w3s/images/ucw-cyfwwsl-executechallenge01.png" />
    </Frame>
