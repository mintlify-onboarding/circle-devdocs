...
For more information on setting up a webhook, refer to the [Webhooks Quickstart](/wallets/webhook-notifications), and optionally watch the following video about Webhook Configurations.
...
For more information, see the [Event Monitoring APIs](/api-reference/event-monitors/get-event-monitors) and join our [Discord - Build on Circle](https://discord.com/invite/buildoncircle) channel.