...
description: Explore this tutorial for transferring USDC between Aptos testnet and Base Sepolia Testnet via CCTP V1
sideNav: ""
documentationItems: 
- title: Documentation
...
```ts // Aptos Testnet Stablecoin object
const BURN_TOKEN =
...
```ts const bytecode = Uint8Array.from(
  fs.readFileSync(
