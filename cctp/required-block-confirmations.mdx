...
<Note>
**Note: Chains without Fast Message Attestation Times**

Some chains don't appear in the Fast Message Attestation Times because their standard attestation times are already very fast. Consequently, Fast Transfer is not applicable when these chains are used as the source chain for burns.

Affected chains: **Arc Testnet, Avalanche, HyperEVM, Polygon PoS, Sei, Sonic, XDC.**
</Note>
