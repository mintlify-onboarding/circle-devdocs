---
title: CCTP FAQ
description: "Learn why Circle created CCTP and how it differs from traditional bridging."
sideNav: ""
...
<Accordion title="How does CCTP differ from lock-and-mint bridging?">
...
<Accordion title="How does CCTP differ from liquidity pool bridging?">
...
<Accordion title="Who is CCTP designed for?">
...
<Accordion title="Does CCTP require signing up with Circle?">
...
<Accordion title="What are the fees associated with cross-chain transfers via CCTP?">
...
<Accordion title="What is the Fast Transfer Allowance in CCTP?">
...
<Accordion title="When will CCTP be available on additional chains?">
...
<Accordion title="Can a blockchain support multiple CCTP versions?">
...
<Accordion title="Can't I use Circle Mint to move USDC across chains? What about a centralized exchange?">
...
<Accordion title="How does a given quantity of USDC burned on the source chain become successfully minted on the destination chain?">
...
<Accordion title="Have the CCTP smart contracts undergone security audits?">
...
<Accordion title="What happens if Circle's Attestation Service is unresponsive?">
...
<Accordion title="How does CCTP affect existing bridged forms of USDC?">

CCTP has no direct impact upon existing bridged forms of USDC.
</Accordion>

<Accordion title="How does CCTP affect Circle's plans to launch USDC on more blockchains?">
