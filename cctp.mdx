...
[Bridge Kit](/bridge-kit) is an SDK that uses CCTP as its protocol provider to let you transfer USDC between blockchains in just a few lines of code
</Note>
