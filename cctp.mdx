...
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| **Finality Time**          | **Fast Transfer:** faster-than-finality, ~8-20 seconds for EVM chains <br /><br /> **Standard Transfer:** <Glossary term="hard finality" />, ~13-19 minutes for Ethereum and L2 chains                                                                                                                                                                                                                          | **Standard Transfer:** hard finality, ~15 to 19 minutes for Ethereum and L2 chains                                       |
...
| **Liquidity**              | Enables native USDC transfers post <Glossary term="soft finality" /> and/or hard finality via a burn and mint method                                                                                                                                                                                                                                                                                            | Enables native USDC transfers post hard finality via a burn and mint method                                              |
...
<Glossary term="Fast Transfer Allowance" /> to enable _faster-than-finality_
