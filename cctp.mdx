...
permalink: "cctp"
'og:title': "Cross-Chain Transfer Protocol"
'og:description': "Move USDC securely across blockchains and simplify user experience"
'twitter:title': "Cross-Chain Transfer Protocol"
'twitter:description': "Move USDC securely across blockchains and simplify user experience"
---
...
**Tip**: Use Bridge Kit for easy crosschain transfers through CCTP.

[Bridge Kit](/bridge-kit) is an SDK that uses CCTP as its protocol provider to
let you transfer USDC between blockchains in just a few lines of code.
...
| **Liquidity** | Enables native USDC transfers post soft finality and/or hard finality via a burn and mint method | Enables native USDC transfers post hard finality via a burn and mint method |
...
Fast Transfer Allowance to enable *faster-than-finality*
...
* [CCTP Technical Guide](/cctp/technical-guide)