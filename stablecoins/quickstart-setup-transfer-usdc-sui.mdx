---
title: 'Quickstart: Set up and transfer USDC on Sui'
description: ''
sideNav: ""
tableOfContents: true
documentationItems: 
- title: Documentation
sidebarTitle: "Transfer USDC on Sui"
---
...
- **[Node.js](https://nodejs.org/en)** and **[npm](https://www.npmjs.com/)**:
  ...
  download and install `Node.js` from [nodejs.org](https://nodejs.org). `npm` comes with
  `Node.js`.
...
<Frame>
  <img src="/stablecoins/images/qs-usdc-sui-app-ui.jpg" />
</Frame>
...
<Frame>
  <img src="/stablecoins/images/qs-usdc-sui-app-tx.png" />
</Frame>
