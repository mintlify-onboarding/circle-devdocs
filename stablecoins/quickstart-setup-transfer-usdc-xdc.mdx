---
title: "Quickstart: Set up and transfer USDC on XDC"
description: 
sideNav: ""
tableOfContents: true
documentationItems: 
- title: Documentation
sidebarTitle: "Transfer USDC on XDC"
---

This guide shows you how to transfer USDC on the XDC Apothem testnet. You'll
...
**To get testnet XDC**  
Use the [XDC faucet](https://faucet.apothem.network/) from the XDC Apothem
testnet network.
</Note>
...
In `index.js`, import required modules and define constants for the XDC Apothem
...
- Loads the XDC Apothem testnet configuration.
...
- Together, these clients give you read and write access to XDC Apothem.
</Accordion>
...
XDC Apothem testnet using Viem and Node.js. Here are the key points to remember:
