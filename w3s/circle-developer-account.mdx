...
<VideoContent
  url="https://fast.wistia.net/embed/iframe/o4x4046yhx?seo=true&videoFoam=true"
  header="Video Tutorial: Walkthrough of the Developer Dashboard"
>
   ...
   - **Restricted Access:** The API keys can be restricted to control their
     ...
     - Select the Product/Service for which the key will have permission:
       ...
       - **Webhooks:** Includes endpoints related to
         [Webhook Subscription APIs](/api-reference/w3s/common/create-subscription).
