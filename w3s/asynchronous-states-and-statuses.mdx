...
associated GET endpoint or via
[subscribing to notifications](/wallets/webhook-notifications) (recommended).

## Transaction States

Transactions go through various states after initiation to indicate if they've
begun processing, are identifiable on the blockchain, complete, failed, and
more.
