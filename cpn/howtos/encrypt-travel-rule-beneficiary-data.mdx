...
description: Establish encrypted messaging during the payment process
sideNav: ""
...
[create a payment](/api-reference/cpn/cpn-platform/create-payment). The above
example uses version 1 for `beneficiaryAccountData` and `travelRuleData` fields.
