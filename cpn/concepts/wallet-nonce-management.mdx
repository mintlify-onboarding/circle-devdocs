...
documentationItems:
  - title: Documentation
sidebarTitle: Wallet Nonce Management
---
...
## Problems with nonce management
...
- Your CPN integration signs two transactions from the same wallet in the right order:
...
- Transaction B goes to the blockchain but gets stuck in the mempool because the blockchain needs nonce 5 first
